...
//! procedural planet. This is the start of the Caelum-style renderer; for now
//! it is a fullscreen raymarch so we have an end-to-end native + WebGPU +
//! GitHub Pages pipeline to build the rest on.
